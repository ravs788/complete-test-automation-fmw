...
namespace UI.Mobile.Pages.Native.Android
{
    /// <summary>
    /// Base page for Android Native screens. Accepts By/AppiumBy locators.
    /// Provides resilient waits and actions with logging.
    /// </summary>
    public abstract class AndroidBasePage
    {
        ...
        protected AndroidBasePage(AppiumDriver driver, ILoggingService logger)
        {
